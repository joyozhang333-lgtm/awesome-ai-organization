...
|-----------|-------|----------|----------|
| [MetaGPT](https://github.com/FoundationAgents/MetaGPT) | 69k+ | Python | Simulating a full software company (PM → Architect → Engineer) |
| [AutoGen / AG2](https://github.com/microsoft/autogen) | 59k+ | Python | Multi-agent conversations, flexible team topologies |
| [CrewAI](https://github.com/crewAIInc/crewAI) | 55k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 118k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 79k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 185k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 147k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 54k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 194k+ | Workflow automation with AI agent nodes |
