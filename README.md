...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 56k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 123k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 81k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 186k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 149k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 55k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 197k+ | Workflow automation with AI agent nodes |
