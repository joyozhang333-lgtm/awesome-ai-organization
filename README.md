...
| [gstack](https://github.com/garrytan/gstack) | 94k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
| [Dify](https://github.com/langgenius/dify) | 141k+ | LLMOps platform — build AI workflows visually |
