...
| [gstack](https://github.com/garrytan/gstack) | 129k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 85k+ | Self-hosted AI software engineer (formerly OpenDevin) |
...
| [n8n](https://github.com/n8n-io/n8n) | 202k+ | Workflow automation with AI agent nodes |
