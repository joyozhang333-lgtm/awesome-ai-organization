...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 48k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 32k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 57k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
| [Dify](https://github.com/langgenius/dify) | 135k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 51k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 182k+ | Workflow automation with AI agent nodes |
