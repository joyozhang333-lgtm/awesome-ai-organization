...
| [gstack](https://github.com/garrytan/gstack) | 99k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 74k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 184k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 142k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 53k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 189k+ | Workflow automation with AI agent nodes |
