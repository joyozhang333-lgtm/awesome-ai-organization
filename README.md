...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 52k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 33k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 102k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 75k+ | Self-hosted AI software engineer (formerly OpenDevin) |
...
| [n8n](https://github.com/n8n-io/n8n) | 190k+ | Workflow automation with AI agent nodes |
