...
|-----------|-------|----------|----------|
| [MetaGPT](https://github.com/FoundationAgents/MetaGPT) | 70k+ | Python | Simulating a full software company (PM → Architect → Engineer) |
| [AutoGen / AG2](https://github.com/microsoft/autogen) | 60k+ | Python | Multi-agent conversations, flexible team topologies |
| [CrewAI](https://github.com/crewAIInc/crewAI) | 57k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 126k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
| [CAMEL](https://github.com/camel-ai/camel) | 18k+ | Python | Role-playing agent pairs, OWL workforce |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 83k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 186k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 151k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 55k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 199k+ | Workflow automation with AI agent nodes |
| [AgentVerse](https://github.com/OpenBMB/AgentVerse) | 5.1k+ | Multi-agent simulation and collaboration |
