...
| [gstack](https://github.com/garrytan/gstack) | 128k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 187k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 153k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 55k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 201k+ | Workflow automation with AI agent nodes |
