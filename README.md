...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 53k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 33k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 108k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 76k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 185k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 144k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 53k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 192k+ | Workflow automation with AI agent nodes |
