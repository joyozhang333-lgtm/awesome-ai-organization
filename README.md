...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 54k+ | Python | Role-playing AI crews with delegation |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | Virtual software company simulation |
| [gstack](https://github.com/garrytan/gstack) | 113k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 78k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 185k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 146k+ | LLMOps platform — build AI workflows visually |
