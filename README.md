...
| [gstack](https://github.com/garrytan/gstack) | 110k+ | Markdown | YC CEO's Claude Code setup — CEO, Eng Manager, QA roles |
...
|-----------|-------|----------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 77k+ | Self-hosted AI software engineer (formerly OpenDevin) |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 185k+ | Autonomous AI agent platform |
| [Dify](https://github.com/langgenius/dify) | 145k+ | LLMOps platform — build AI workflows visually |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 54k+ | Drag-and-drop LLM flow builder |
| [n8n](https://github.com/n8n-io/n8n) | 193k+ | Workflow automation with AI agent nodes |
