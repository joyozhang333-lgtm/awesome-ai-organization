...
| [CrewAI](https://github.com/crewAIInc/crewAI) | 55k+ | Python | 角色扮演 AI 团队，支持委派 |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | 虚拟软件公司模拟 |
| [gstack](https://github.com/garrytan/gstack) | 122k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| [n8n](https://github.com/n8n-io/n8n) | 196k+ | 工作流自动化 + AI Agent 节点 |
