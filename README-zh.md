...
| [AutoGen / AG2](https://github.com/microsoft/autogen) | 60k+ | Python | 多智能体对话，灵活团队拓扑 |
| [CrewAI](https://github.com/crewAIInc/crewAI) | 57k+ | Python | 角色扮演 AI 团队，支持委派 |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 34k+ | Python | 虚拟软件公司模拟 |
| [gstack](https://github.com/garrytan/gstack) | 126k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| 框架 | Star 数 | 最适合 |
|------|---------|--------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 83k+ | 自托管 AI 软件工程师（原 OpenDevin） |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 186k+ | 自主 AI Agent 平台 |
| [Dify](https://github.com/langgenius/dify) | 151k+ | LLMOps 平台——可视化构建 AI 工作流 |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 55k+ | 拖拽式 LLM 流程构建器 |
| [n8n](https://github.com/n8n-io/n8n) | 199k+ | 工作流自动化 + AI Agent 节点 |
