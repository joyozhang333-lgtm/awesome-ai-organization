...
| [gstack](https://github.com/garrytan/gstack) | 94k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| [Dify](https://github.com/langgenius/dify) | 141k+ | LLMOps 平台——可视化构建 AI 工作流 |
