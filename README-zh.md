...
| [gstack](https://github.com/garrytan/gstack) | 132k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| [Dify](https://github.com/langgenius/dify) | 155k+ | LLMOps 平台——可视化构建 AI 工作流 |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 55k+ | 拖拽式 LLM 流程构建器 |
| [n8n](https://github.com/n8n-io/n8n) | 204k+ | 工作流自动化 + AI Agent 节点 |
