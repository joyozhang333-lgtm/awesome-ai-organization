...
| [gstack](https://github.com/garrytan/gstack) | 128k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| 框架 | Star 数 | 最适合 |
|------|---------|--------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 84k+ | 自托管 AI 软件工程师（原 OpenDevin） |
...
| [n8n](https://github.com/n8n-io/n8n) | 201k+ | 工作流自动化 + AI Agent 节点 |
