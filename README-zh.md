...
| [AutoGen / AG2](https://github.com/microsoft/autogen) | 55k+ | Python | 多智能体对话，灵活团队拓扑 |
| [CrewAI](https://github.com/crewAIInc/crewAI) | 46k+ | Python | 角色扮演 AI 团队，支持委派 |
| [ChatDev](https://github.com/OpenBMB/ChatDev) | 31k+ | Python | 虚拟软件公司模拟 |
| [gstack](https://github.com/garrytan/gstack) | 22k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
| [CAMEL](https://github.com/camel-ai/camel) | 10k+ | Python | 角色扮演智能体对，OWL 劳动力 |
