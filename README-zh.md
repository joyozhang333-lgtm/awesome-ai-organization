...
| [gstack](https://github.com/garrytan/gstack) | 110k+ | Markdown | YC CEO 的 Claude Code 配置——CEO、工程经理、QA 角色 |
...
| 框架 | Star 数 | 最适合 |
|------|---------|--------|
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 77k+ | 自托管 AI 软件工程师（原 OpenDevin） |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 185k+ | 自主 AI Agent 平台 |
| [Dify](https://github.com/langgenius/dify) | 145k+ | LLMOps 平台——可视化构建 AI 工作流 |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 54k+ | 拖拽式 LLM 流程构建器 |
| [n8n](https://github.com/n8n-io/n8n) | 193k+ | 工作流自动化 + AI Agent 节点 |
